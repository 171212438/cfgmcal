 ...
 * FILE: board_spec.h
 * BOARD FAMILY:
 *    TriBoard TC3X4L V1.0
 * UC SUPPORT:
 *    TC374, TC364  (LQFP-144 Package)
 * DESCRIPTION:
...
#if defined(TRIBOARD_TC3X4L_V1_0)
...
#define BOARD_TLF35584_SLS_INDEX       6    /* Pin index in port - SLSO2 */
#define BOARD_TLF35584_SLS_PC          0x13  /* SLS Output function for I/O */

#define BOARD_TLF35584_SCLK_PORT       15   /* Serial Clock */
#define BOARD_TLF35584_SCLK_INDEX      8    /* Pin index in port */
...
#define BOARD_TLF35584_MRST_PORT       15   /* Master Receive Slave Transmit - Input E */
#define BOARD_TLF35584_MRST_INDEX      2    /* Pin index in port */

#endif

#endif  /* BOARD_SPEC_H */
#endif  /* TRIBOARD_TC3X4L_V1_0 */
