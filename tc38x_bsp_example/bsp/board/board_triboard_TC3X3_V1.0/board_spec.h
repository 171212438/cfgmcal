...
#if defined(TRIBOARD_TC3X3_V1_0)
...
#define BOARD_TLF35584_SLS_INDEX       11    /* Pin index in port */
...
#define BOARD_TLF35584_MRST_PORT       11    /* Master Receive Slave Transmit */
