...
/* IfxSfr_Pmu_Registers_BitfieldsMask */
/* Length for Ifx_PMU_ID_Bits.MOD_REV */
#define IFX_PMU_ID_MOD_REV_LEN (8u)

/* Mask for Ifx_PMU_ID_Bits.MOD_REV */
#define IFX_PMU_ID_MOD_REV_MSK (0xffu)

/* Offset for Ifx_PMU_ID_Bits.MOD_REV */
#define IFX_PMU_ID_MOD_REV_OFF (0u)

/* Length for Ifx_PMU_ID_Bits.MOD_TYPE */
#define IFX_PMU_ID_MOD_TYPE_LEN (8u)

/* Mask for Ifx_PMU_ID_Bits.MOD_TYPE */
#define IFX_PMU_ID_MOD_TYPE_MSK (0xffu)

/* Offset for Ifx_PMU_ID_Bits.MOD_TYPE */
#define IFX_PMU_ID_MOD_TYPE_OFF (8u)

/* Length for Ifx_PMU_ID_Bits.MOD_NUMBER */
#define IFX_PMU_ID_MOD_NUMBER_LEN (16u)

/* Mask for Ifx_PMU_ID_Bits.MOD_NUMBER */
#define IFX_PMU_ID_MOD_NUMBER_MSK (0xffffu)

/* Offset for Ifx_PMU_ID_Bits.MOD_NUMBER */
