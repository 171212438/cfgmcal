...
/* IfxSfr_Pmu_Registers_Bitfields */
...
typedef union
{
    ...
    Ifx_PMU_ID_Bits B;                /* Bitfield access */
} Ifx_PMU_ID;


/******************************************************************************/
/* IfxSfr_Pmu_Registers_struct */
/******************************************************************************/
/** \name Object L0
 * \{  */
...
{
       Ifx_UReg_8Bit                       reserved_0[1288];       /* 0, internal Reserved */
       Ifx_PMU_ID                          ID;                     /* 508, Module Identification Register*/
       Ifx_UReg_8Bit                       reserved_50C[31476];    /* 50C, internal Reserved */
} Ifx_PMU;
