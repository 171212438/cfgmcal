...
/* IfxSfr_Fce_Registers_Bitfields */
...
{
    Ifx_UReg_32Bit CH0:1;             /* [0:0] Channel0 Status - CH0 (rh) */
    Ifx_UReg_32Bit CH1:1;             /* [1:1] Channel1 Status - CH1 (rh) */
    Ifx_UReg_32Bit CH2:1;             /* [2:2] Channel2 Status - CH2 (rh) */
    Ifx_UReg_32Bit CH3:1;             /* [3:3] Channel3 Status - CH3 (rh) */
    Ifx_UReg_32Bit CH4:1;             /* [4:4] Channel4 Status - CH4 (rh) */
    Ifx_UReg_32Bit CH5:1;             /* [5:5] Channel5 Status - CH5 (rh) */
    Ifx_UReg_32Bit CH6:1;             /* [6:6] Channel6 Status - CH6 (rh) */
    Ifx_UReg_32Bit CH7:1;             /* [7:7] Channel7 Status - CH7 (rh) */
...
{
    Ifx_UReg_32Bit CMI:1;             /* [0:0] CRC Mismatch Interrupt - CMI (rw) */
    Ifx_UReg_32Bit CEI:1;             /* [1:1] Configuration Error Interrupt - CEI (rw) */
    Ifx_UReg_32Bit LEI:1;             /* [2:2] Length Error Interrupt - LEI (rw) */
    Ifx_UReg_32Bit BEI:1;             /* [3:3] Bus Error Interrupt - BEI (rw) */
    Ifx_UReg_32Bit CCE:1;             /* [4:4] CRC Check Comparison - CCE (rw) */
    Ifx_UReg_32Bit ALR:1;             /* [5:5] Automatic Length Reload - ALR (rw) */
    Ifx_UReg_32Bit reserved_6:2;      /* [7:6] internal Reserved */
    Ifx_UReg_32Bit REFIN:1;           /* [8:8] IR Byte Wise Reflection - REFIN (rw) */
    Ifx_UReg_32Bit REFOUT:1;          /* [9:9] CRC Bit Wise Reflection - REFOUT (rw) */
    Ifx_UReg_32Bit XSEL:1;            /* [10:10] Selects the value to be xored with the final CRC - XSEL (rw) */
    Ifx_UReg_32Bit BYTESWAP:1;        /* [11:11] Swaps the order of the bytes in the IR input register. - BYTESWAP (rw) */
    Ifx_UReg_32Bit reserved_12:4;     /* [15:12] internal Reserved */
    Ifx_UReg_32Bit KERNEL:4;          /* [19:16] Selects the CRC Kernel (Polynomial Engine) used by this channel. - KERNEL (rw) */
...
{
    Ifx_UReg_32Bit CHECK:32;          /* [31:0] CHECK Register - CHECK (rw) */
} Ifx_FCE_IN_CHECK_Bits;

/* CRC Regsister i */
typedef struct _Ifx_FCE_IN_CRC_Bits
{
    Ifx_UReg_32Bit CRC:32;            /* [31:0] CRC Register - CRC (rwh) */
} Ifx_FCE_IN_CRC_Bits;

/* CRC Test Register i */
typedef struct _Ifx_FCE_IN_CTR_Bits
{
    Ifx_UReg_32Bit FCM:1;             /* [0:0] Force CRC Mismatch - FCM (rw) */
    Ifx_UReg_32Bit FRM_CFG:1;         /* [1:1] Force CFG Register Mismatch - FRM_CFG (rw) */
    Ifx_UReg_32Bit FRM_CHECK:1;       /* [2:2] Force Check Register Mismatch - FRM_CHECK (rw) */
...
{
    Ifx_UReg_32Bit IR:32;             /* [31:0] Input Register - IR (rw) */
} Ifx_FCE_IN_IR_Bits;

/* CRC Length Register i */
typedef struct _Ifx_FCE_IN_LENGTH_Bits
{
    Ifx_UReg_32Bit LENGTH:16;         /* [15:0] Message Length Register - LENGTH (rwh) */
...
{
    Ifx_UReg_32Bit RES:32;            /* [31:0] Result Register - RES (rh) */
} Ifx_FCE_IN_RES_Bits;

/* CRC Status Register i */
typedef struct _Ifx_FCE_IN_STS_Bits
{
    Ifx_UReg_32Bit CMF:1;             /* [0:0] CRC Mismatch Flag - CMF (rwh) */
    Ifx_UReg_32Bit CEF:1;             /* [1:1] Configuration Error Flag - CEF (rwh) */
    Ifx_UReg_32Bit LEF:1;             /* [2:2] Length Error Flag - LEF (rwh) */
    Ifx_UReg_32Bit BEF:1;             /* [3:3] Bus Error Flag - BEF (rwh) */
...
typedef struct _Ifx_FCE_KRST0_Bits
{
    ...
    Ifx_UReg_32Bit RSTSTAT:1;         /* [1:1] Kernel Reset Status - RSTSTAT (r) */
    Ifx_UReg_32Bit reserved_2:30;     /* [31:2] internal Reserved */
} Ifx_FCE_KRST0_Bits;
...
typedef union
{
    ...
    Ifx_FCE_ACCEN0_Bits B;            /* Bitfield access */
} Ifx_FCE_ACCEN0;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_ACCEN1_Bits B;            /* Bitfield access */
} Ifx_FCE_ACCEN1;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_CHSTS_Bits B;             /* Bitfield access */
} Ifx_FCE_CHSTS;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_CLC_Bits B;               /* Bitfield access */
} Ifx_FCE_CLC;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_ID_Bits B;                /* Bitfield access */
} Ifx_FCE_ID;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_CFG_Bits B;            /* Bitfield access */
} Ifx_FCE_IN_CFG;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_CHECK_Bits B;          /* Bitfield access */
} Ifx_FCE_IN_CHECK;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_CRC_Bits B;            /* Bitfield access */
} Ifx_FCE_IN_CRC;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_CTR_Bits B;            /* Bitfield access */
} Ifx_FCE_IN_CTR;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_IR_Bits B;             /* Bitfield access */
} Ifx_FCE_IN_IR;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_LENGTH_Bits B;         /* Bitfield access */
} Ifx_FCE_IN_LENGTH;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_RES_Bits B;            /* Bitfield access */
} Ifx_FCE_IN_RES;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_IN_STS_Bits B;            /* Bitfield access */
} Ifx_FCE_IN_STS;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_KRST0_Bits B;             /* Bitfield access */
} Ifx_FCE_KRST0;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_KRST1_Bits B;             /* Bitfield access */
} Ifx_FCE_KRST1;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /* Unsigned access */
    Ifx_SReg_32Bit I;                 /* Signed access */
    Ifx_FCE_KRSTCLR_Bits B;           /* Bitfield access */
} Ifx_FCE_KRSTCLR;


/******************************************************************************/
/******************************************************************************/
/* IfxSfr_Fce_IN_struct */
/******************************************************************************/
/** \name Object L1
 * \{  */
/* IN object */
...
{
       Ifx_FCE_IN_IR                       IR;                     /* 0, Input Register ${i}*/
       Ifx_FCE_IN_RES                      RES;                    /* 4, CRC Result Register ${i}*/
       Ifx_FCE_IN_CFG                      CFG;                    /* 8, CRC Configuration Register ${i}*/
       Ifx_FCE_IN_STS                      STS;                    /* C, CRC Status Register ${i}*/
       Ifx_FCE_IN_LENGTH                   LENGTH;                 /* 10, CRC Length Register ${i}*/
       Ifx_FCE_IN_CHECK                    CHECK;                  /* 14, CRC Check Register ${i}*/
       Ifx_FCE_IN_CRC                      CRC;                    /* 18, CRC Regsister ${i}*/
       Ifx_FCE_IN_CTR                      CTR;                    /* 1C, CRC Test Register ${i}*/
} Ifx_FCE_IN;
/******************************************************************************/
/******************************************************************************/
/******************************************************************************/
...
{
       Ifx_FCE_CLC                         CLC;                    /* 0, Clock Control Register*/
       Ifx_UReg_8Bit                       reserved_4[4];          /* 4, internal Reserved */
       Ifx_FCE_ID                          ID;                     /* 8, Module Identification Register*/
       Ifx_UReg_8Bit                       reserved_C[20];         /* C, internal Reserved */
       Ifx_FCE_CHSTS                       CHSTS;                  /* 20, Channels Status Register*/
       Ifx_UReg_8Bit                       reserved_24[200];       /* 24, internal Reserved */
       Ifx_FCE_KRSTCLR                     KRSTCLR;                /* EC, Kernel Reset Status Clear Register*/
       Ifx_FCE_KRST1                       KRST1;                  /* F0, Kernel Reset Register 1*/
       Ifx_FCE_KRST0                       KRST0;                  /* F4, Kernel Reset Register 0*/
       Ifx_FCE_ACCEN1                      ACCEN1;                 /* F8, Access Enable Register 1*/
       Ifx_FCE_ACCEN0                      ACCEN0;                 /* FC, Access Enable Register 0*/
       Ifx_FCE_IN                          IN[8];                  /* 100, CRC Test Register ${i}*/
} Ifx_FCE;
